...
class DecodeDetections(Layer):
    ...
    def call(self, y_pred, mask=None):
        ...
        """
        # y_pred (0...90,ty,tx,th,tw,cx_anchor,cy_anchor,w_anchor,h_anchor,cx_variance,cy_variance,w_variance,h_variance)
        #####################################################################################
        ...
        # has variances
        # tw = y_pred[...,-9]/width_scale
        # th = y_pred[...,-10]/height_scale
        # tx = y_pred[...,-11]/x_scale
        # ty = y_pred[...,-12]/y_scale

        # no variances
        tw = y_pred[...,-5]/width_scale
        th = y_pred[...,-6]/height_scale
        tx = y_pred[...,-7]/x_scale
        ty = y_pred[...,-8]/y_scale
        ...
        # now anchor yxhw and no variances
        ha = y_pred[...,-2]
        wa = y_pred[...,-1]
        ya = y_pred[...,-4]
        xa = y_pred[...,-3]
        ...
        # no variances
        y_pred = tf.concat(values=[y_pred[..., :-8], xmin, ymin, xmax, ymax], axis=-1)

        print("after norm and concat",y_pred)
        ...
        def filter_predictions(batch_item):
            ...
            def filter_single_class(index):
                ...
                print("after nms",single_class_nms)
