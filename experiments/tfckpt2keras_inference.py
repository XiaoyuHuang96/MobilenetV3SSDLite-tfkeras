...
weights_path = './pretrained_weights/tf_convert_mbv3ssdlite_small_0527.h5'
...
# model.load_weights("./ourmodels/loaded_small_0527_weights.h5",by_name=True)
...
# save weights
model.save_weights("./ourmodels/loaded_large_0528_weights.h5")
...
decoder = DecodeDetections(confidence_thresh=confidence_thresh,
